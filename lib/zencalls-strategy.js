...
async function scanSymbol(symbol, price, daily, weekly, monthly, dailyK, state, now, webhook, acc) {
...
async function processSymbol(symbol, state, now, webhook, acc) {
  try {
    ...
    await scanSymbol(symbol, price, dailyPivot, weeklyPivot, monthlyPivot, dailyK, state, now, webhook, acc);
  } catch (e) {
