...
function detectSignal(data, pricePrecision = 2, context = {}) {
  ...
  // $75M floor: XPINUSDT ($16M) and VANRYUSDT ($50M) caused 4 of 5 losses on 07/13 this way.
  // Coins above $75M still get the volume quality bonus at $100M and $500M tiers below.
  if (quoteVolume > 0 && quoteVolume < 75_000_000) return null;
